...
/**
 * Returns YES if seconday native infeed ad is ready for display.
 * Returns NO if seconday native infeed ad view not ready or failed.
 */
- (BOOL)isSecondaryAdReady;

/**
 * The secondary ad view of the native ad. This view is rendered by InMobi and should be used by the publisher to display the ad. Impressions will be computed on this view.
 * @param width The width of the primary view. Typically this should be the screen width.
 */
- (UIView *)secondaryInfeedAdViewOfWidth:(CGFloat)width;

/**
 * Gets the winning bid price in case of second price
 */
- (void)setWinningPrice:(float) price;
